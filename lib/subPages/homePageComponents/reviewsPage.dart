...
Widget listOfReviews(BuildContext context,docId) {
              ...
              SliverList(
                delegate: SliverChildBuilderDelegate(
                    ...
                    return Padding(
                      ...
                      child: shopReviewListItems(context, data),
                    );
                  },
 ...
 shopReviewListItems(BuildContext context, data) {
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  subtitle: Row(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(left: 0.0, right: 5.0, top: 5,bottom: 5),
                        child: Text(
                          '$shopRatings',
                      ...
                      Padding(
                          padding:
                          EdgeInsets.only(left: 0.0, right: 20.0, top: 5,bottom: 5),
                          child: Icon(
                            Icons.star,
                            size: 18,
                            color: secondary,
